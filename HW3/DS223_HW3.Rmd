...
the CLV is very similar across service categories — the differences are quite small, 
meaning service type alone does not strongly determine lifetime value. And as for gender,
...
internet services increase expected lifetime (time ratios > 1), indicating 
slower churn hazard and higher retention stability. 
...
To conclude, the most valuable customers are therefore the high-tier subscribers,
especially those with both voice and internet services, as they exhibit higher 
CLV, lower churn risk, and more stable engagement.
Most effective retention focus is:
Basic service customers with high churn risk, especially those not enrolled in 
bundled offerings.
